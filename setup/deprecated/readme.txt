...
consolidate_yearly::__init__::
"name": "consolidate"
"<M>": "MLD"
"<S>": "DB6/"

run_multileveldecomposition::
"ymd": ('<TIME_BEGIN>', '<TIME_END>', '30min')
"output_path": "<MOTHER>/output/MLD/<SITE>_EC{}_{}.{}mn.csv"
"averaging": [30, 5]
"varstorun": ['co2*w', 'h2o*w', 't_sonic*w']

run_multileveldecomposition::__init__::
"name": "Multilevel Decomposition"

run_multileveldecomposition::raw_kwargs::
"file_pattern": ".*_raw_dataset_([0-9]*).csv"
"mother_path": "<MOTHER><RAWPATH>/level_6_good_units/"
...
run_crosswavelets::fkwargs::
"datefomatfrom": "%Y-%m-%dT%H:%M:%S.%f"

run_crosswavelets::wv_kwargs::
"dj": 0.125
"dt": 0.05
"mother": "MexicanHat"

run_crosswavelets::prepare_kwargs::
"path": "<MOTHER><RAWPATH>/level_6_good_units/"
"max_period": 43200
